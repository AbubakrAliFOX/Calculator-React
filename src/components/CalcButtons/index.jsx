        ...
        <form className="button-body">
          <section className="">
            <div className="row justify-content-between mx-1">
                ...
                <button className="button" value={'subtraction'} onClick={logic.subtract}>−</button>
            </div>
            <div className="row justify-content-between mx-1">
                ...
                <button className="button" value={'division'} onClick={logic.divide}>/</button>
            </div>
            <div className="row justify-content-between mx-1 my-2">
                ...
                <button className="button" value={'multiplication'} onClick={logic.multiply}>X</button>
            </div>
            <div className="row justify-content-between mx-1 my-2">
                ...
                <button className="button" value={'addition'} onClick={logic.makeOperation}>+</button>
            </div>
            <div className="row justify-content-between mx-1 my-2">
